    ...
    <>
      ...
      <Animated.ScrollView
        ...
        <View className="mb-20 mt-10">
          ...
          <Text className="text-lg text-text opacity-50">Welcome to my playground</Text>
        </View>
        ...
        <View className="flex-row" style={{ paddingBottom: insets.bottom }}>
          ...
          <Animated.View
            className="mb-44 w-1/2 flex-col pl-1"
            style={{
...
const MasonryItem = ({ source, height, text, textPosition = 'bottom' }: MasonryItemProps) => {
  return (
    <ImageBackground
      ...
      className="mb-2 w-full overflow-hidden rounded-2xl">
      {text && (
        <LinearGradient
          style={{
            position: 'absolute',
