...
export default function ConfirmVisitOrderScreen() {
        ...
        const loadData = async () => {
            try {
                ...
                const [orderData, crewData] = await Promise.all([
                    ...
                    installer?.crew?._id ? crewService.getCrewById(installer.crew._id) : Promise.resolve(null)
                ]);
    ...
    const handleCreateVisit = async () => {
        ...
        try {
            ...
            const newTicketId = originOrder.ticket_id ? `${originOrder.ticket_id}-V` : `VISIT-${Date.now()}`;
        ...
        >
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.inputContainer}>
                    ...
                    <Text style={styles.helperText}>
                        Describe la razón de esta visita técnica.
                    </Text>
                    <TextInput
            ...
            <View style={[styles.footer]}>
                <TouchableOpacity
                    style={[
                        styles.createButton,
                        (!logEntry.trim() || submitting) && styles.disabledButton
                    ]}
