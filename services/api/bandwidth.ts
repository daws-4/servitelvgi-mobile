...
export const bandwidthApi = {
     ...
     */
    getDataUsage: async (installerId: string, startDate?: string, endDate?: string): Promise<DataUsageRecord[]> => {
     ...
     */
    createDataUsage: async (installerId: string, wifiBytes: number, mobileBytes: number): Promise<DataUsageRecord> => {
     ...
     */
    updateDataUsage: async (id: string, installerId: string, wifiBytes: number, mobileBytes: number): Promise<DataUsageRecord> => {
