...
> = {
  location: {
    ...
    message:
      'ENLARED necesita acceso a tu ubicación para mostrar tu posición en el mapa y optimizar las rutas de instalación. Esto nos ayuda a asignar las órdenes más cercanas a ti.',
    icon: 'location',
  },
  camera: {
    title: 'Permiso de Cámara',
    message:
      'Se necesita acceso a la cámara para tomar fotos de las instalaciones y documentar el trabajo realizado. Esto es importante para el registro de evidencia.',
    icon: 'camera',
  },
  notifications: {
    title: 'Permiso de Notificaciones',
    message:
      'Las notificaciones te permiten recibir actualizaciones sobre nuevas órdenes de trabajo asignadas y cambios importantes en tiempo real.',
    icon: 'notifications',
  },
};
  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onDismiss}>
      <Pressable style={styles.overlay} onPress={onDismiss}>
        <Pressable
          style={[styles.dialog, { backgroundColor: secondary, borderColor: border }]}
          ...
          <View
            style={[
              ...
              { backgroundColor: `${BrandColors.primary}10`, borderColor: BrandColors.primary },
            ]}>
