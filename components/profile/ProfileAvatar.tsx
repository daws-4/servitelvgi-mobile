 ...
 * ```
 */
export default function ProfileAvatar({ imageUri, size = 112, onCameraPress }: ProfileAvatarProps) {
  ...
  return (
    <View style={[styles.container, { width: size, height: size }]}>
      ...
      {/* Camera Button */}
      {onCameraPress && (
        <TouchableOpacity style={styles.cameraButton} onPress={onCameraPress} activeOpacity={0.7}>
