...
import { View, Text, StyleSheet, TouchableOpacity, Modal, ActivityIndicator, Image, Alert, Dimensions } from 'react-native';
...
export default function CustomerSignature({
    ...
    const handleRemoveSignature = () => {
        Alert.alert(
            'Eliminar Firma',
            '¿Está seguro que desea eliminar la firma del cliente?',
            [
        ...
        <View style={styles.container}>
            ...
            >
                <View style={styles.modalContainer}>
                    ...
                    <TouchableOpacity
                        style={[styles.saveButton, (!tempSignature || saving || processing) && styles.saveButtonDisabled]}
                        onPress={handleSave}
