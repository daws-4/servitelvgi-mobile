...
export const BandwidthStats = () => {
  const { stats, loadStats, resetStats, updateStats, wifiUsage, mobileUsage, totalUsage } =
    useBandwidthStats();
        ...
        <View style={styles.row}>
          ...
          <View style={styles.info}>
            ...
            <Text style={styles.subtext}>
              ↓{' '}
              {stats.wifi.bytesReceived > 0
                ? (stats.wifi.bytesReceived / 1024).toFixed(1) + 'KB'
                : '0KB'}{' '}
              · ↑{' '}
      ...
      <View style={styles.card}>
        <View style={styles.row}>
          ...
          <View style={styles.info}>
            ...
            <Text style={styles.subtext}>
              ↓{' '}
              {stats.mobile.bytesReceived > 0
                ? (stats.mobile.bytesReceived / 1024).toFixed(1) + 'KB'
                : '0KB'}{' '}
              · ↑{' '}
              {stats.mobile.bytesSent > 0
                ? (stats.mobile.bytesSent / 1024).toFixed(1) + 'KB'
                : '0KB'}
            </Text>
          </View>
        </View>
